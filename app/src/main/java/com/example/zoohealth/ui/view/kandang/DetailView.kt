    ...
    when {
        ...
        detailUiState.isUiEventNotEmpty -> {
            Column(
                ...
                ItemDetailKandang(
                    kandang = detailUiState.detailUiEvent.toKandang(),
                    modifier = modifier
                )
...
fun ItemDetailKandang(
    ...
    Card(
        ...
        Column(
            ...
            ComponentDetailKandang(judul = "ID Hewan", isinya = kandang.idHewan.toString())
            Spacer(modifier = Modifier.padding(4.dp))
            ComponentDetailKandang(judul = "Kapasitas", isinya = kandang.kapasitas.toString())
            Spacer(modifier = Modifier.padding(4.dp))
